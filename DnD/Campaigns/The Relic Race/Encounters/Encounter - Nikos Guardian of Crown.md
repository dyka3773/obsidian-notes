...
difficulty: Hard
party_level: 1
encounter_type: Combat/Boss Battle/Social
status: planned
---
The party reaches the relic chamber and confronts [[Nikos - Oathbound Guardian]], an ancient warrior sworn to protect [[The Crown of Kings]]. This is the pivotal encounter. Combat, negotiation, or alliance are all possible.

## Overview
The party enters a circular chamber of breathtaking beauty. At its center, on a stone pedestal, rests [[The Crown of Kings]], glowing with subtle magical light. Before the pedestal stands [[Nikos - Oathbound Guardian]], a scarred warrior who has watched over this relic for centuries. He will not let it leave willingly.

## Encounter Type
- **Type**: Boss Battle / Negotiation / Alliance Opportunity
- **Location**: [[Location - Thessaloniki Catacombs]] (relic chamber, deepest level)
- **Difficulty**: Hard (combat-focused) or Medium (negotiation-focused)
- **Party Level**: 1
...
### [[Nikos - Oathbound Guardian]]'s Initial Reaction
...
## [[Nikos - Oathbound Guardian]] Combat Stats

See [[Nikos - Oathbound Guardian]] for full stat block, but here are key abilities:
...
Actions:
- +1 Longsword: +6 to hit, 1d8+5 slashing (or 1d10+5 two-handed)
- Parry: Reduce damage taken by 1d8
- Second Wind: Regain 1d10+8 HP (1/rest)

Legendary Actions (3/turn if combat begins):
- Attack
- Parry
- Move
```
...
### Path 1: Combat ([[Nikos - Oathbound Guardian]] Fights)

**When does it happen?**
- Party immediately attacks without talking
- Party tries to grab the crown despite his warnings
- Party insults Alexander or the relic disrespectfully

**The Fight**:
1. **Round 1**: [[Nikos - Oathbound Guardian]] draws his sword and moves to intercept the crown-grabber
...
**If Party Defeats [[Nikos - Oathbound Guardian]]**:
...
- [[Nikos - Oathbound Guardian]] doesn't kill them; he disarms them and forces them away
- "You are not ready. Leave this place. Before I am forced to end you."
- They must flee or negotiate

### Path 2: Negotiation/Dialogue (Recommended)

**What the Party Might Say**:
- "We were hired to steal this, but we want to know the truth"
- "Who are you? Why do you guard this?"
...
**Result**: [[Nikos - Oathbound Guardian]] becomes an ally. He can:
- Provide tactical knowledge of the catacombs
- Use the crown to amplify his own power temporarily
- Die heroically defending the party if needed (for drama)

### Path 3: Steal the Crown (Tricky)

**If the party tries to grab the crown while [[Nikos - Oathbound Guardian]] watches**:
- [[Nikos - Oathbound Guardian]] moves faster than expected (reaction action)
- Grapple check: Party vs. [[Nikos - Oathbound Guardian]]'s Strength check (+5 bonus)
- If party wins: They have the crown, but [[Nikos - Oathbound Guardian]] is enraged and attacks
- If [[Nikos - Oathbound Guardian]] wins: He wrestles them away, combat begins

**Note**: The crown itself is NOT trapped with curses; it's just protected by [[Nikos - Oathbound Guardian]].

## The Deeper Truth (If [[Nikos - Oathbound Guardian]] Reveals It)
...
**Why [[Nikos - Oathbound Guardian]] Guards It**:
- The last person who tried to use it became obsessed with resurrecting Darius III as a vessel to control
- [[Nikos - Oathbound Guardian]] stopped them, sealed the crown away
- He's been guarding it ever since, waiting for someone worth the responsibility

## Encounter Progression

### Timeline
- **5-10 minutes**: Initial dialogue/investigation
- **1 minute**: The party decides: fight, negotiate, or attempt theft
- **15-20 minutes**: Combat (if it happens) or deep negotiation
- **5 minutes**: Resolution and preparation for next encounter

## The Moral Choice

**Key Moment**: If [[Nikos - Oathbound Guardian]] trusts the party and they ally with him, they face a choice later:
- Destroy the crown (ending the threat but losing immense power)
- Keep it safe ([[Nikos - Oathbound Guardian]] watches over it, but temptation remains)
- Try to use it (dangerous & corrupting)
- Hide it elsewhere ([[Nikos - Oathbound Guardian]] refuses unless they prove themselves)