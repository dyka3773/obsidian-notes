...
**Encounters**:
- Pickpockets, drunken brawls, shady deals
- Faction spies gathering intelligence
...
**Features**:
- Open-air market (food, crafts, minor magic items)
- Council Hall (where nobles and the Archon meet)
- Courthouse and city guard headquarters
- Public forum (announcements, debates, executions)

**Key Locations**:
- **Council Hall** (faction representatives meet here)
- **The Grand Market** (shops, traders, artisans)
- **City Guard Barracks**

**Encounters**:
- Faction diplomats making public speeches
- Merchants selling information or goods
...
**Features**:
- Smithies, leatherworkers, alchemists, enchanters
- Workshops where minor magic items are crafted
...
**Encounters**:
- Artificers looking for rare materials
- Guilds hiring the party for protection or retrieval
- Rival craftsmen sabotaging each other
...
- Gated compounds with private guards
- The Archon's residence

**Key Locations**:
- **The Archon's Palace** (if party needs to meet the government)
- **Noble houses** (potential employers or rivals)

**Encounters**:
- Invitations to political dinners (intrigue, alliances)
...
- Illegal gambling dens, drug houses
- Cult safe houses (if the party investigates)

**Encounters**:
- Muggings, gang fights
- Desperate people offering information for coin
...
**Features**:
- [[Thessaloniki Collegiate of Magic]] (see [[Magical Academies]])
- Library, lecture halls, student dormitories
- Warded grounds (unauthorized entry is difficult)

**Key Locations**:
- **The Grand Library** (party can research relics here)
- **Faculty offices** (consultations for a fee)
- **Student common areas** (potential NPC allies)

**Encounters**:
- Students practicing spells (sometimes accidents happen)
- Faculty hiring the party for fieldwork
- Rival scholars trying to steal research
...
- Knows where Cult remnants hide
...
**Location**: Council Hall (Agora)
**Disposition**: Pragmatic, stressed (dealing with Relic Race fallout)
**Campaign Use**:
- Hires the party for official business
- Mediates faction conflicts
...
**Location**: The Collegiate
**Disposition**: Curious about the party (wants relic information)
**Campaign Use**:
- Grants library access (for a favor)
- Hires the party to retrieve magical components
