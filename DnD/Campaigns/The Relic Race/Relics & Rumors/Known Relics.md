...
A catalog of confirmed and rumored relics in *[[The Relic Race]]* campaign.

---
## Overview

**What Are Relics?**
Legendary artifacts from history, powerful, rare, and politically significant.

**Why They Matter**:
- **Symbols of legitimacy** ("I have Alexander's Crown --> I am his successor")
- **Military advantages** (one relic can equal 1,000 soldiers)
- **Divine curiosities** (proof of myths and legends)
- **Political leverage** (nations trade land, wealth, or alliances for them)

**Campaign Philosophy**:
You don't need to predefine every relic. Let **rumors** drive the story, if players hear about an artifact, *then* you design it.

---
## Confirmed Relics (The Party Knows These Exist)

### [[The Crown of Kings]]

**Full Details**: See [[The Crown of Kings]] (one-shot loot file)

**Owner**: Alexander the Great (historical)
**Current Status**: [DM determines based on one-shot outcome]
- Option 1: Party has it
- Option 2: Party hid it
- Option 3: Party gave it to a faction
- Option 4: Party destroyed it

**Powers** (Summary):
- **[[Command]] Dominion**: Force obedience from those nearby (legendary Charisma)
- **Summon Loyalty**: Compel soldiers to fight for you
...
These are **not** fully designed yet. Create stats when the party pursues them.
...
- A museum or noble's collection (stolen from an archaeological site)
...
---
### The Disc of Phaistos (Deciphered)

**Rumor**: 
*"An ancient Minoan artifact, covered in undeciphered symbols. Scholars believe it's a map—or a key to something far older than Greece itself."*

**Possible Location**:
- Crete (Minoan ruins, real-world site: Knossos)
- A private collector's vault
- Lost at sea, recently recovered

**Possible Powers** (when deciphered):
- **Map to a Lost Civilization**: Reveals location of a pre-Greek empire (Atlantis? Minoan treasure vaults?)
...
- Atlantis (if you want to introduce a sunken civilization)
- Held by a sea monster (guardian)
...
**Rumor**: 
*"Jason and the Argonauts retrieved it from Colchis. It granted kingship and protection to whoever possessed it. After Jason's death, it vanished."*

**Possible Location**:
- Colchis (real-world Georgia, eastern Black Sea)
- Stolen and hidden by a dragon (classic fantasy)
- A temple in Thessaloniki (brought back and forgotten)
...
### Darius III's Scepter (Counterpart to the Crown)

**Rumor**: 
*"If Alexander's Crown exists, so does Darius's Scepter—the Persian symbol of kingship. Together, they could rewrite history."*
...
---
## Designing New Relics (DM Toolkit)
...
- **Very Rare**: +2 weapon, moderate effects (2-3 spells, combat advantages)
- **Legendary**: +3 weapon, game-changing powers (reshape battles, political leverage)
...
- What happens if the party gets it?
...
### Legendary Relic Effects (In Player Hands)
If the party wields a relic in battle:
- **Morale Impact**: Enemies may flee (or fight harder to claim it)
- **Faction Attention**: Using a relic publicly draws faction agents
- **NPC Reactions**: Allies are inspired, enemies are terrified
### Legendary Relic Effects (In Villain Hands)
If a faction leader wields a relic:
- **Boss Fight Enhancement**: Add lair actions or legendary actions
- **Narrative Weight**: The villain's speech references the relic's power
- **Defeat Opportunity**: Stealing/destroying the relic weakens the villain

---
## DM Notes: Relic Campaign Pacing

### Early Campaign (Levels 2-4)
- **1-2 relics** in play (Crown + 1 rumored)
- Focus on factions competing for the Crown
- Introduce rumors about others
### Mid Campaign (Levels 5-8)
- **3-5 relics** discovered or pursued
- Party has choices (which relic to pursue?)
- Factions gain or lose relics (power shifts)
### Late Campaign (Levels 9+)
- **Major relics** are in play (Trident, Thunderbolt, etc.)
- Factions use relics in open conflict
- Party decides the fate of relics (hoard, destroy, distribute?)