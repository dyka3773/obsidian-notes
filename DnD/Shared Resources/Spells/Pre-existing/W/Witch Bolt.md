...
#Level1 #Evocation ( #Sorcerer, #Warlock, #Wizard)
...
The spell ends if the target is ever outside the spell’s range or if it has [Total Cover](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Cover) from you.
