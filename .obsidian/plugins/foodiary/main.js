...
var FoodiarySettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Products").setHeading();
    ...
    new import_obsidian.Setting(containerEl).setName("Property for cholesterol").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Property for sodium").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Property for fiber").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Property for daily calorie goal").setDesc("Leave it blank if you do not want to set the goal.").addText(
      (text) => text.setPlaceholder(DEFAULT_SETTINGS.propertyDailyCalorieGoal.toString()).setValue(this.plugin.settings.propertyDailyCalorieGoal.toString()).onChange(async (value) => {
        value = value.trim();
        if (value == "") {
...
var FoodiaryCodeBlock = class {
  ...
  static async fileProperties(plugin, file) {
    var _a;
    return (_a = plugin.app.metadataCache.getFileCache(file)) == null ? void 0 : _a.frontmatter;
  }
